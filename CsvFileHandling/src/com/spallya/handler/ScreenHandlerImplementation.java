...
public class ScreenHandlerImplementation implements ScreenHandler {
	...
	static ScreenHandlerImplementation screenHandlerImplementationObj = new ScreenHandlerImplementation();
	...
	public static String[] columnNames = { "street", "city", "zip", "state", "beds", "baths", "sqFeet", "type",
